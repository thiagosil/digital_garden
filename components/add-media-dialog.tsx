            ...
            <div className="space-y-2">
              ...
              <div className="space-y-2 max-h-96 overflow-y-auto">
                {searchResults.map((result) => (
                  <div
                    key={result.apiId}
                    className="flex gap-4 p-3 border rounded-lg hover:bg-accent transition-colors"
                  >
                    <div className="w-16 h-24 bg-muted rounded flex-shrink-0 relative overflow-hidden">
                      {result.coverImage ? (
                        <Image
